      ...
      <div className='detail-project-container'>
        ...
        <div className='flex items-center justify-center gap-10 h-screen'>
          {projects.map((project, index) => (
            ...
            >
              <div
                className='flex flex-col bg-[#fff] rounded '
              ...
              >
                ...
                <div className='flex flex-col justify-center items-center p-8 '>
                  ...
                  <div className='flex justify-center items-center tracking-wide drop-shadow-lg mt-5'>
                    <Button className='mr-3 bg-[#AE5CF2] text-white text-sm rounded px-5 py-2 '>
                      <a href={project.github} target='_blank'>
                        Github
                      </a>
                    </Button>
                    <Button className='ml-1 bg-[#AE5CF2] text-white text-sm rounded px-2 py-2 '>
